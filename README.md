...
1. Clone the repo
   ```sh
   git clone https://github.com/elybellyalecole/boitiersonnerie
   ```
...
- Il y a 2 types d'alarme : Séisme et Intrusion.

- Ces alarmes seront actionnées et arrêtées à l'aide de boutons poussoirs.

- Les alarmes devront paralyser les sonneries. 
